...
set CLASSPATH=%APP_HOME%\lib\Simulation_of_Life-1.0-SNAPSHOT.jar;%APP_HOME%\lib\javafx-fxml-19-win.jar;%APP_HOME%\lib\javafx-controls-19-win.jar;%APP_HOME%\lib\javafx-controls-19.jar;%APP_HOME%\lib\javafx-media-19-win.jar;%APP_HOME%\lib\javafx-graphics-19-win.jar;%APP_HOME%\lib\javafx-graphics-19.jar;%APP_HOME%\lib\javafx-base-19-win.jar;%APP_HOME%\lib\javafx-base-19.jar;%APP_HOME%\lib\fxgl-17.jar;%APP_HOME%\lib\opencsv-5.7.0.jar;%APP_HOME%\lib\gson-2.10.jar;%APP_HOME%\lib\fxgl-io-17.jar;%APP_HOME%\lib\fxgl-entity-17.jar;%APP_HOME%\lib\fxgl-gameplay-17.jar;%APP_HOME%\lib\fxgl-scene-17.jar;%APP_HOME%\lib\fxgl-core-17.jar;%APP_HOME%\lib\jackson-annotations-2.12.1.jar;%APP_HOME%\lib\jackson-core-2.12.1.jar;%APP_HOME%\lib\jackson-databind-2.12.1.jar;%APP_HOME%\lib\lifecycle-4.0.9.jar;%APP_HOME%\lib\kotlin-stdlib-1.5.32-modular.jar;%APP_HOME%\lib\commons-text-1.9.jar;%APP_HOME%\lib\commons-lang3-3.12.0.jar;%APP_HOME%\lib\commons-beanutils-1.9.4.jar;%APP_HOME%\lib\commons-collections4-4.4.jar;%APP_HOME%\lib\audio-4.0.9.jar;%APP_HOME%\lib\storage-4.0.9.jar;%APP_HOME%\lib\util-4.0.9.jar;%APP_HOME%\lib\annotations-13.0.jar;%APP_HOME%\lib\kotlin-stdlib-common-1.5.32.jar;%APP_HOME%\lib\commons-logging-1.2.jar;%APP_HOME%\lib\commons-collections-3.2.2.jar
